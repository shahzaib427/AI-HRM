...
class WellnessCoach:
    def __init__(self):
        ...
        print("Initializing Wellness Coach...")
        print("✅ Wellness Coach initialized (using rule-based system)")
    ...
    def generate_recommendations(self, data: WellnessInput) -> tuple:
        ...
        # 6. Time-specific recommendations
        ...
        return unique_recs[:5], None, None  # Return top 5 recommendations, no sentiment/emotion
...
def predict(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if action == 'full_assessment':
            ...
            return {
                'status': 'error',
                'message': f'Unknown action: {action}. Available actions: full_assessment, quick_check, recommendations, status'
            }
