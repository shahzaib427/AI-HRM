...
const AdminReports = () => {
  ...
  // ✅ Fixed: GET instead of PUT, responseType blob, proper file download
  const handleDownload = async (report) => {
    ...
    try {
      ...
      // Refresh to show updated downloadCount
      fetchReports();
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 mb-6">
          <KpiCard title="Total Reports" value={stats.totalReports} icon={DocumentTextIcon} color="bg-blue-500" subtext="All time reports" />
          <KpiCard title="This Month" value={stats.generatedThisMonth} icon={CalendarIcon} color="bg-green-500" subtext="Generated in current month" />
          ...
          <KpiCard title="Scheduled" value={stats.scheduledReports} icon={ChartBarIcon} color="bg-amber-500" subtext="Pending generation" />
          <KpiCard title="Shared Reports" value={stats.sharedReports} icon={UserGroupIcon} color="bg-indigo-500" subtext="Available to HR team" />
        </div>
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 text-sm rounded-lg transition-colors ${
                            currentPage === pageNum ? 'bg-indigo-600 text-white' : 'border border-gray-200 hover:bg-gray-50'
                          }`}
                        >
                          {pageNum}
                        </button>
