...
import { 
  ...
  FiChevronRight, FiEye, FiMoreVertical, FiMail, FiUsers
} from 'react-icons/fi';
...
const AdminAttendance = () => {
  ...
  const [stats, setStats] = useState({ total: 0, present: 0, late: 0, avgHours: 0 });
  ...
  const calculateStats = (records) => {
    ...
    setStats({ total, present, late, avgHours });
  };
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Monitor and manage employee attendance records (AI Face Recognition)</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KpiCard icon={FiCheck} label="Present" value={stats.present} sub="Checked in" iconBg="bg-emerald-500" />
