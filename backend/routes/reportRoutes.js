...
// ⚠️  /:id/download MUST be before /:id — otherwise Express matches
//     "download" as the :id param and hits getReportById first
router.get('/:id/download', authorize('admin', 'hr'), downloadReport);
